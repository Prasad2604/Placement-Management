...
export default function CompanyLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await authService.loginCompany(email, password);
          ...
          <div className="flex-1 justify-center mt-[10%] space-y-5 text-center">
            <div className="space-y-2">
              <h1 className="text-2xl text-blue-500 font-semibold">
                Sign-in to PICT PUNE Placement Portal
              </h1>
            ...
            <div className="flex-1 space-y-4">
              ...
              >
                ...
                <div className="flex-1 justify-center space-y-2">
                  {/* <h1>OR</h1> */}
                  <Button
                    className="  ml-[47%] hover:bg-white "
